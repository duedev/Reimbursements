...
# Meals: quick-serve, coffee, casual dining — the "food" report category
# (working meals need their own section for expense review).
_FOOD_BRANDS: dict[str, set[str]] = {
    "Starbucks":      {"starbucks"},
...
# Lodging: hotels/motels/short-stay — the "hotel" report category.
_HOTEL_BRANDS: dict[str, set[str]] = {
    "Marriott":       {"marriott"},
...
KNOWN_VENDORS: dict[str, tuple[str, set[str]]] = {
    ...
    **_tag(_FOOD_BRANDS, "food"),
    **_tag(_HOTEL_BRANDS, "hotel"),
